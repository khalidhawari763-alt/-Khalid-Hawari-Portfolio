 ...
 */
export const createContactMessage = async (contactMessageInput: ContactMessageInput, options?: Parameters<typeof customFetch>[1]): Promise<ContactMessageReceipt> => {

  return customFetch<ContactMessageReceipt>(getCreateContactMessageUrl(),
  {
    ...options,
    method: 'POST',
